	...
	class Tree
{
	...
	public boolean SetRight(Treern) 
	{
		right = rn;
		return true;
	}
	public boolean SetLeft(Treeln) 
	{
		left = ln;
		return true;
	}
	...
	public boolean Remove(Treep_node,Treec_node) 
	{
		boolean ntb;
		int auxkey1;
		int auxkey2;
	...
	public boolean RemoveRight(Treep_node,Treec_node) 
	{
		boolean ntb;
	...
	public boolean RemoveLeft(Treep_node,Treec_node) 
	{
		boolean ntb;
	...
	public boolean RecPrint(Treenode) 
	{
		boolean ntb;
		if (node.GetHas_Left() ) 
		{
	...
	class Visitor
{
	...
	class MyVisitorextends Visitor
{
	public int visit(Treen) 
	{
		int nti;
